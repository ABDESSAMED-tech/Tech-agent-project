...
/**
 * The <code>RuleVariable</code> class implements the rule variable class used
 * in a boolean rule base.
 *
...
public class RuleVariable extends Variable {
    ...
    /**
     * Set the value of the variable and retests all clauses that refer to this
     * variable.
     *
