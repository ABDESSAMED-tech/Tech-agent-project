 ...
 * @author ABEDSSAMED
 */
public class Magasin2 extends Agent {
    ...
    protected void setup() {
        ...
        try {
            ...
            Logger.getLogger(Magasin2.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        addBehaviour(new WakerBehaviour(this, d) {
            ...
            protected void onWake() {
                ...
                for (Map.Entry<String, ag.Produit> entry : data.infoMagasin1.entrySet()) {
                    ...
                    p.price = (int) (p.price - (p.price * 0.3));
