 ...
 * @author ABEDSSAMED
 */
public class Magasin3 extends Agent {
    ...
    protected void setup() {
        ...
        try {
            d = dateformat3.parse("08/07/2022");
        } catch (java.text.ParseException ex) {
            Logger.getLogger(Magasin3.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        addBehaviour(new WakerBehaviour(this, d) {
            ...
            protected void onWake() {
                ...
                for (Map.Entry<String, ag.Produit> entry : data.infoMagasin1.entrySet()) {
                    ...
                    p.price = (int) (p.price - (p.price * 0.2));
                    ...
                    try {
                        ...
                        if (p.quantity >= Integer.parseInt(l.get(0))) {
                            ...
                            if (Integer.parseInt(l.get(0)) > 1) {
                                ...
                                MAINFrame.priceLabel.setText("Prix = " + ((data.infoMagasin1.get(l.get(1)).price * (Integer.parseInt(l.get(0)))) - ((data.infoMagasin1.get(l.get(1)).price * (Integer.parseInt(l.get(0)))) * Integer.parseInt(l.get(0)) * 5 / 100)));
                                MAINFrame.promoLabel.setText("Promo de " + Integer.parseInt(l.get(0)) * 5 + "%");
                                MAINFrame.priceLabel.setVisible(true);
                                MAINFrame.promoLabel.setVisible(true);

                            } else {
                                MAINFrame.priceLabel.setText("Prix = " + ((data.infoMagasin1.get(l.get(1)).price * (Integer.parseInt(l.get(0))))));
                                MAINFrame.priceLabel.setVisible(true);
                            }
                        } else {
