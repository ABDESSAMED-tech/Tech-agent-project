...
public class BooleanRuleBase implements RuleBase {
     ...
     *
     * @param text the String that contains the text to be displayed as part of
     ...
     *
     * @param test the boolean value that determines if the antecedents should
     * be tested (<code>true</code>) or just checked (<code>false</code>)
    ...
    public Vector<Rule> match(boolean test) {
        ...
        for (int i = 0; i < matchList.size(); i++) {
            conflit = conflit + "Conflite Set :["+s +"]: "+ matchList.get(i).name + "\n ";
    ...
    public void setConflit() {
        this.conflit = this.conflit + "\n";
    }
    ...
    public void forwardChain() {
        ...
        while (conflictRuleSet.size() > 0) {
            ...
            SelectedRule=SelectedRule+"Selected rule["+s+"]: "+selected.name+"\n ";
     ...
     *
     * @param effectorName the String that contains the name of the effector to
     * be be retrieved
     *
     ...
     *
     * @return a Hashtable object that contains the list of variables defined in
     * this ruleset
     */
